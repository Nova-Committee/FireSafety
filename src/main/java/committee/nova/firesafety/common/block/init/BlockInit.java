...
public class BlockInit {
    ...
    private static void registerBlockItem(String id, RegistryObject<Block> block) {
        TabInit.itemsIn.add(ITEMS.register(id, () -> new BlockItem(block.get(), new Item.Properties())));
    }
}
