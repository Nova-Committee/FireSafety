...
public class WaterBombProjectile extends FunctionalProjectile {
    ...
    public static void bombard(Level world, BlockPos pos) {
        ...
        final var bomb = new WaterBombProjectile(pos.getX() + random.nextDouble(), pos.getY() + random.nextDouble(), pos.getZ() + random.nextDouble(), world);
    ...
    public void onRemovedFromWorld() {
        ...
        for (int i = 0; i < 10; i++) {
            level.addAlwaysVisibleParticle(CAMPFIRE_COSY_SMOKE, getX() + random.nextDouble() - .3, getY(), getZ() + random.nextDouble() - .3, 0, 0, 0);
        }
    }
}
