...
public class EventHandler {
    ...
    public static void onExtension(FireSafetyExtensionEvent event) {
        ...
        event.addExtinguishable(MODNAME, (short) -32000, new FireSafetyApi.ExtinguishableEntity((w, e) -> e.getType().is(BURNING), (w, e) -> e.hurt(e.damageSources().freeze(), freezeDamage.get().floatValue())));
